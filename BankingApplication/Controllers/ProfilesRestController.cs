...
{
    public class ProfilesRestController : ApiController
    {
        private AccountContext db = new AccountContext();

        // GET: api/ProfilesRest
        public IQueryable<Profile> GetProfiles()
        {
            return db.Profiles;
        }

        // GET: api/ProfilesRest/5
